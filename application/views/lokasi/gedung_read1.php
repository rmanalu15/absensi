      ...
      <div class='box'>
        ...
        <div class='box-body'>
          <table class="table table-bordered table-striped" id="mytable">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td style='text-align:center;'><?php echo $gedung->nis ?></td>
                  <td style='text-align:center;'><?php echo $gedung->nama_santri ?></td>
            ...
            <tr>
              <td colspan="5" style="text-align:center;"><?php echo anchor('lokasi1', 'Kembali', array('class' => 'btn btn-indigo btn-lg')); ?></td>
            </tr>
          </table>
